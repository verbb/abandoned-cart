...
return [
  ...
  'Blacklisted Emails/Domains' => 'Blacklisted Emails/Domains',
  ...
  'Enter emails or domains seperated by a comma that should be ignored.' => 'Enter emails or domains seperated by a comma that should be ignored.',
  ...
  'How many hours after a cart has been abandoned should the 1st reminder be sent.<br /><i>Note: Carts are marked abandoned 1 hour after no activity.</i>' => 'How many hours after a cart has been abandoned should the 1st reminder be sent.<br /><i>Note: Carts are marked abandoned 1 hour after no activity.</i>',
  'How many hours after a cart has been abandoned should the 2nd reminder be sent.' => 'How many hours after a cart has been abandoned should the 2nd reminder be sent.',
  'How many hours should abandoned cart restore links last for after being sent.' => 'How many hours should abandoned cart restore links last for after being sent.',
  'If disabled only the 1st reminder will be sent.' => 'If disabled only the 1st reminder will be sent.',
  'No abandoned carts exist yet.' => 'No abandoned carts exist yet.',
  ...
  'Previous Order Required' => 'Previous Order Required',
  'Recovered' => 'Recovered',
  ...
  'Whether emails should be sent only if the user has made an order previously.' => 'Whether emails should be sent only if the user has made an order previously.',
